...
namespace MedBuy.Api.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> LogOff()
        {
            ...
            return RedirectToAction(nameof(ProductoController.Get), "Producto");
        }
        ...
        public async Task<IActionResult> VerifyAuthenticatorCode(bool rememberMe, string returnUrl = null)
        {
            ...
            return Ok(new VerifyAuthenticatorCodeViewModel { ReturnUrl = returnUrl, RememberMe = rememberMe });
        }
        ...
        public async Task<IActionResult> UseRecoveryCode(string returnUrl = null)
        {
            ...
            return Ok(new UseRecoveryCodeViewModel { ReturnUrl = returnUrl });
        }
